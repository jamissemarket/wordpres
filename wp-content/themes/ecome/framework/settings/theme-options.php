				...
				'sections' => array(
					...
					array(
						...
						'fields' => array(
							...
							'blog_content_overflow'  => array(
								'id'      => 'blog_content_overflow',
								'type'    => 'select',
								'default' => 'visible',
								'title'   => esc_html__( 'Blog Content Overflow', 'ecome' ),
								'options' => array(
									'visible' => esc_html__( 'Visible', 'ecome' ),
									'hidden'  => esc_html__( 'Hidden', 'ecome' )
								)
							),
						),
					),
					...
					'sections' => array(
						array(
							...
							'fields' => array(
								...
								array(
									'id'         => 'ecome_woo_bestseller_enable',
									'type'       => 'switcher',
									'title'      => esc_html__( 'Enable Best Seller Products', 'ecome' ),
									'dependency' => array( 'ecome_woo_cat_enable', '==', true ),
								),
